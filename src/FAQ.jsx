...
const FAQ = () => (
  <section className="bg-[#0C1A2A] p-10 text-white">
    <h2 className="text-2xl font-bold text-center">Common Questions & Answers</h2>
    ...
    <div className="mt-8 space-y-6">
      <details className="mb-4">
        <summary className="cursor-pointer font-bold">What is Zoomster Hub?</summary>
        <p className="mt-2">
      ...
      <details className="mb-4">
        <summary className="cursor-pointer font-bold">Why Should I Use Zoomster Hub?</summary>
        <p className="mt-2">
      ...
      <details className="mb-4">
        <summary className="cursor-pointer font-bold">How Do I Get Started with Zoomster Hub?</summary>
        <p className="mt-2">
      ...
      <details className="mb-4">
        <summary className="cursor-pointer font-bold">What Features Does Zoomster Hub Offer?</summary>
        <p className="mt-2">
      ...
      <details className="mb-4">
        <summary className="cursor-pointer font-bold">Can I Integrate Zoomster Hub with My Existing Tools?</summary>
        <p className="mt-2">
      ...
      <details className="mb-4">
        <summary className="cursor-pointer font-bold">Is Customer Support Available?</summary>
        <p className="mt-2">
